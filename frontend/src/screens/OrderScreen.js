            ...
            <Col md={8}>
                <ListGroup variant='flush'>
                    <ListGroup.Item>
                        ...
                        <p>
                            Địa chỉ email:
                            <a href={`Mail đến: ${order.user.email}`}>{order.user.email}</a>
                        </p>
                        <p>
                        ...
                        {order.isDelivered ? <Message variant='success'>Vận chuyển lúc: {order.deliveredAt}</Message> : <Message variant='danger'>Chưa vận chuyển</Message>}
                    </ListGroup.Item>
                    ...
                    <ListGroup.Item>
                        ...
                        {order.isPaid ? <Message variant='success'>Thanh toán lúc: {order.paidAt}</Message> : <Message variant='danger'>Chưa thanh toán</Message>}
                    </ListGroup.Item>

                    <ListGroup.Item>
                        <h2>Mặt hàng mua: </h2>
                        {order.orderItems.length === 0 ? <Message>Đơn hàng trống !!!</Message> : (
                            <ListGroup variant='flush'>
