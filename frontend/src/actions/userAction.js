...
export const register = (name, phone, email, password) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.post('/api/users', { name, phone, email, password }, config)
        dispatch({
